...
<template>
  <div class="overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
      ...
      <tfoot>
        <tr class="font-semibold text-gray-900 dark:text-white" v-if="showNewClientForm">
          <td class="px-6 py-3">
            <button
        ...
        <tr v-else>
          ...
          <td class="px-6 py-3">
            <button
              type="button"
              class="focus:outline-none text-white bg-lime-700 hover:bg-lime-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
            >
              Guardar
            </button>
            <button
